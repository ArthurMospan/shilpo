...
8. "question" — постав питання, ТІЛЬКИ якщо без відповіді неможливо обрати ЯКИЙ САМЕ товар шукати:
   • нерозбірливий почерк → «Тут написано "сир"?»
   • назва надто загальна і варіанти суттєво різні → «Яку каву — зернову, мелену чи розчинну?»
   НІКОЛИ не питай про кількість: гість виставить її повзунком у застосунку, і питання в чаті лише забирає час.
   Якщо питання не потрібне — порожній рядок. НЕ питай про очевидне. Максимум одне питання на позицію.
9. "options" — 2–4 короткі варіанти відповіді (до 20 символів). Порожній масив, якщо питання немає.
